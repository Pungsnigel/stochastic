...
for iGeneration = 1:numberOfGenerations % Main algorithm loop
    ...
    end % end loop over population

    for i = 1:populationSize
        originalChromosome = tempPopulation(1,:);
        mutatedChromosome = Mutate(originalChromosome, mutationProbability);
        tempPopulation(i,:) = mutatedChromosome;
    end

    tempPosition(1,:) = population(bestIndividualIndex,:);  % elitism
